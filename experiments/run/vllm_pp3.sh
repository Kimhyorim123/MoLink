...
# vLLM baseline: 3-GPU pipeline parallel (PP=3) over Ray.
# Start Ray head/worker first across node4/5/6.
...
echo "[vllm] starting baseline PP=3 on $HOST:$PORT model=$MODEL"
